...
async function serveur() {
  ...
  await t('S14.10', '/health : v4.2 ou plus, couche 5.29.5 ou plus, et quel en-tete identifie le visiteur', () => ({ ok: /^v4\.[2-9]$/.test(h.passerelle) && /^5\.29\.[5-9]$/.test(h.couche) && typeof h.ip === 'string', info: h.passerelle + ' ' + h.couche + ' ip=' + h.ip }));
